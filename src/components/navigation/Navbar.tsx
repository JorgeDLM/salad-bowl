      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <Link
              href="/admin/login"
              className="px-6 py-2 bg-white text-sb-green-700 rounded-full font-bold hover:bg-sb-cream transition-all shadow-md hover:shadow-lg flex items-center gap-2"
            >
              Iniciar Sesión
            </Link>
          </div>
        ...
        {isMenuOpen && (
          <div className="md:hidden py-4 border-t border-sb-cream/20">
            <div className="flex flex-col gap-4">
              ...
              <Link
                href="/admin/login"
                className="mt-2 px-6 py-3 bg-white text-sb-green-700 rounded-full font-bold text-center hover:bg-sb-cream transition-all shadow-md flex items-center justify-center gap-2"
                onClick={() => setIsMenuOpen(false)}
              >
