...
export default function ContactModal({ isOpen, onClose }: ContactModalProps) {
  ...
  const handleWhatsApp = () => {
    const message = encodeURIComponent('¡Hola Adriana! Me interesa conocer más sobre tu experiencia liderando equipos de marketing y gestionando audiencias masivas. ¿Podríamos agendar una conversación? 👋');
    ...
    <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-[200] flex items-center justify-center p-4">
      <div className="bg-stone-900 border-4 border-stone-400 p-8 max-w-md w-full shadow-2xl" style={{
        ...
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-2xl font-black text-stone-200 uppercase tracking-wide">CONTACTAR</h2>
          <button
            onClick={onClose}
