...
export default function DashboardLayout({ children, userEmail, userRole }: DashboardLayoutProps) {
  ...
  const navigation = {
    ...
    FRANCHISEE: [
      { name: 'Inicio', href: '/franchisee/dashboard', icon: 'home' },
      { name: 'Guías y Recursos', href: '/franchisee/dashboard/guides', icon: 'book' },
      // { name: 'Operaciones', href: '/franchisee/dashboard/operations', icon: 'chart' },
      { name: 'Configuración', href: '/franchisee/dashboard/settings', icon: 'settings' },
    ],
    EMPLOYEE: [
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="p-4 border-t border-gray-200">
            ...
            <form action={logoutAction}>
              <button
                type="submit"
                className="w-full px-4 py-2 text-sm font-medium text-gray-700 bg-gray-50 hover:bg-gray-100 rounded-lg transition-colors flex items-center gap-2"
              >
